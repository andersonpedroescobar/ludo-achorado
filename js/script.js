...
// Usamos parte de la ruta roja para definir dónde pueden aparecer regalos (el camino común)
...
function iluminarFichasMovibles() {
    ...
    if (!hayMovimientos) {
        document.getElementById('game-msg').innerText = "🚫 Sin movimientos.";
...
function decidirSiguienteTurno(updates) {
    if (gameState.ultimoValorDado === 6) {
        ...
        // Aquí iría la lógica de saltar turnos congelados, pero por simplicidad pasamos turno normal.
        // Si el siguiente tiene sanción, debería saltarse en su propio turno (mejora futura).
